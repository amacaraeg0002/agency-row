...
export type PackId = 
  | "nba-pack" | "nfl-pack" | "mlb-pack" | "nhl-pack" | "soccer-pack" | "combat-pack" | "tennis-pack" 
  | "silver-plus" | "gold-plus" | "diamond-plus" | "hero-vault";
...
export interface GameSave { 
  ...
  agencyXp: number;
  agencyLevel: number;
  inventory: Partial<Record<CardId, OwnedCard>>; 
  activeCard: CardId; 
  staff: Staff[]; 
  upgrades: { sponsor: number; floor: number; }; 
  nextId: number; 
  clockMs: number; 
