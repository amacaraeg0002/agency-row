...
export const CARDS: Record<CardId, Card> = {
  ...
  "hero-jones": { id: "hero-jones", name: "Jon Jones '23", sport: "Combat Sports", rarity: "Hero", ovr: 90, baseViews: 66000, cpm: 19, theme: "Champion Heroes", quirks: ["#WalkoffKO"], color: "#000000", number: "1", imageUrl: "https://a.espncdn.com/i/headshots/mma/players/full/2335639.png" },
  ...
  "nba-ant": { id: "nba-ant", name: "Anthony Edwards", sport: "Basketball", rarity: "Diamond", ovr: 93, baseViews: 35000, cpm: 15, theme: "Live Series", quirks: ["#SHOWTIME"], color: "#0C2340", number: "5", imageUrl: "https://a.espncdn.com/i/headshots/nba/players/full/4592275.png" },
  "nba-shai": { id: "nba-shai", name: "Shai Gilgeous-Alexander", sport: "Basketball", rarity: "Gold", ovr: 92, baseViews: 32000, cpm: 14, theme: "Live Series", quirks: [], color: "#007AC1", number: "2", imageUrl: "https://a.espncdn.com/i/headshots/nba/players/full/4278073.png" },
  "nba-brunson": { id: "nba-brunson", name: "Jalen Brunson", sport: "Basketball", rarity: "Silver", ovr: 88, baseViews: 22000, cpm: 11, theme: "Live Series", quirks: [], color: "#F58426", number: "11", imageUrl: "https://a.espncdn.com/i/headshots/nba/players/full/3934672.png" },
  ...
  "mlb-soto": { id: "mlb-soto", name: "Juan Soto", sport: "Baseball", rarity: "Diamond", ovr: 96, baseViews: 39000, cpm: 16, theme: "Live Series", quirks: [], color: "#003087", number: "22", imageUrl: "https://a.espncdn.com/i/headshots/mlb/players/full/36969.png" },
  "mlb-witt": { id: "mlb-witt", name: "Bobby Witt Jr.", sport: "Baseball", rarity: "Gold", ovr: 93, baseViews: 33000, cpm: 14, theme: "Live Series", quirks: ["#SHOWTIME"], color: "#004687", number: "7", imageUrl: "https://a.espncdn.com/i/headshots/mlb/players/full/41031.png" },
  ...
  "nhl-bedard": { id: "nhl-bedard", name: "Connor Bedard", sport: "Hockey", rarity: "Silver", ovr: 87, baseViews: 20000, cpm: 10, theme: "Live Series", quirks: ["#SHOWTIME"], color: "#CF0A2C", number: "98", imageUrl: "https://a.espncdn.com/i/headshots/nhl/players/full/5121665.png" },
  ...
  "soc-yamal": { id: "soc-yamal", name: "Lamine Yamal", sport: "Soccer", rarity: "Silver", ovr: 86, baseViews: 24000, cpm: 11, theme: "Live Series", quirks: [], color: "#A50044", number: "19", imageUrl: "https://a.espncdn.com/i/headshots/soccer/players/full/352936.png" },
  ...
  "com-makhachev": { id: "com-makhachev", name: "Islam Makhachev", sport: "Combat Sports", rarity: "Gold", ovr: 94, baseViews: 32000, cpm: 14, theme: "Live Series", quirks: [], color: "#000000", number: "1", imageUrl: "https://a.espncdn.com/i/headshots/mma/players/full/4025175.png" },
...
export const PACKS: Record<PackId, { name: string; price: number; count: number; description: string; color: string; odds: readonly (readonly [CardId, number])[] }> = {
  "nba-pack": { name: "NBA Live Pack", price: 2_500, count: 2, description: "Live Series Basketball.", color: "border-orange-500", odds: [["nba-brunson", 0.5], ["nba-shai", 0.35], ["nba-ant", 0.1], ["nba-wemby", 0.04], ["nba-luka", 0.008], ["nba-curry", 0.002]] },
  "nfl-pack": { name: "NFL Live Pack", price: 2_500, count: 2, description: "Live Series Football.", color: "border-blue-500", odds: [["nfl-stroud", 0.6], ["nfl-allen", 0.25], ["nfl-jefferson", 0.1], ["nfl-mccaffrey", 0.045], ["nfl-lamar", 0.005]] },
  "mlb-pack": { name: "MLB Live Pack", price: 2_500, count: 2, description: "Live Series Baseball.", color: "border-red-500", odds: [["mlb-holliday", 0.55], ["mlb-witt", 0.25], ["mlb-soto", 0.15], ["mlb-judge", 0.045], ["mlb-ohtani", 0.005]] },
  "nhl-pack": { name: "NHL Live Pack", price: 2_500, count: 2, description: "Live Series Hockey.", color: "border-cyan-500", odds: [["nhl-bedard", 0.65], ["nhl-kucherov", 0.25], ["nhl-matthews", 0.09], ["nhl-mackinnon", 0.01]] },
  "soccer-pack": { name: "World Soccer Pack", price: 2_500, count: 2, description: "Live Series Soccer.", color: "border-emerald-500", odds: [["soc-yamal", 0.65], ["soc-bellingham", 0.25], ["soc-mbappe", 0.09], ["soc-ronaldo", 0.01]] },
  "combat-pack": { name: "Combat Sports Pack", price: 2_000, count: 1, description: "Combat Sports cards.", color: "border-red-900", odds: [["com-makhachev", 0.8], ["com-pereira", 0.2]] },
  "tennis-pack": { name: "Tennis Tour Pack", price: 2_000, count: 1, description: "Tennis cards.", color: "border-lime-500", odds: [["ten-sinner", 0.8], ["ten-alcaraz", 0.2]] },
  "silver-plus": { name: "Silver+ Multi-Sport", price: 10_000, count: 3, description: "Guaranteed high-level pull.", color: "border-slate-400", odds: [["nfl-stroud", 0.2], ["mlb-holliday", 0.2], ["nba-brunson", 0.2], ["nhl-bedard", 0.2], ["soc-yamal", 0.1], ["mlb-soto", 0.05], ["nfl-jefferson", 0.04], ["nba-wemby", 0.01]] },
  "diamond-plus": { name: "Diamond+ Multi-Sport", price: 50_000, count: 2, description: "Only Diamonds and Mythics.", color: "border-cyan-300", odds: [["nba-wemby", 0.25], ["nfl-jefferson", 0.25], ["mlb-soto", 0.25], ["nhl-matthews", 0.1], ["soc-mbappe", 0.1], ["nba-luka", 0.02], ["mlb-judge", 0.02], ["mlb-ohtani", 0.01]] },
  "hero-vault": { name: "Champion Heroes Vault", price: 250_000, count: 1, description: "Guaranteed Champion Hero (2016-2026 MVPs).", color: "border-fuchsia-500", odds: [["hero-jones", 0.25], ["hero-seager", 0.25], ["hero-jokic", 0.2], ["hero-mcdavid", 0.15], ["hero-messi", 0.1], ["hero-mahomes", 0.04], ["hero-lebron", 0.01]] },
};
