...
export const PACKS: Record<PackId, { name: string; price: number; count: number; description: string; color: string; odds: readonly (readonly [CardId, number])[] }> = {
  "nba-pack": { name: "NBA Live Pack", price: 2_500, count: 2, description: "Live Series Basketball.", color: "border-orange-500", odds: [["nba-shai", 0.5], ["nba-tatum", 0.35], ["nba-ant", 0.1], ["nba-wemby", 0.04], ["nba-luka", 0.008], ["nba-curry", 0.002]] },
  ...
  "mlb-pack": { name: "MLB Live Pack", price: 2_500, count: 2, description: "Live Series Baseball.", color: "border-red-500", odds: [["mlb-holliday", 0.6], ["mlb-harper", 0.25], ["mlb-soto", 0.12], ["mlb-judge", 0.025], ["mlb-ohtani", 0.005]] },
  "nhl-pack": { name: "NHL Live Pack", price: 2_500, count: 2, description: "Live Series Hockey.", color: "border-cyan-500", odds: [["nhl-kucherov", 0.65], ["nhl-matthews", 0.3], ["nhl-mackinnon", 0.05]] },
  "soccer-pack": { name: "World Soccer Pack", price: 2_500, count: 2, description: "Live Series Soccer.", color: "border-emerald-500", odds: [["soc-bellingham", 0.65], ["soc-mbappe", 0.3], ["soc-ronaldo", 0.05]] },
  "combat-pack": { name: "Combat Sports Pack", price: 2_000, count: 1, description: "Combat Sports cards.", color: "border-red-900", odds: [["com-pereira", 1.0]] },
  "tennis-pack": { name: "Tennis Tour Pack", price: 2_000, count: 1, description: "Tennis cards.", color: "border-lime-500", odds: [["ten-alcaraz", 1.0]] },
  "silver-plus": { name: "Silver+ Multi-Sport", price: 10_000, count: 3, description: "Guaranteed high-level pull.", color: "border-slate-400", odds: [["nfl-stroud", 0.2], ["mlb-holliday", 0.2], ["nba-shai", 0.2], ["nhl-kucherov", 0.2], ["soc-bellingham", 0.1], ["mlb-soto", 0.05], ["nfl-jefferson", 0.04], ["nba-wemby", 0.01]] },
